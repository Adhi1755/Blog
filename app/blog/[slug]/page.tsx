...
function RenderBlock({ block }: { block: ContentBlock }) {
  switch (block.type) {
      ...
      return (
        <div className="overflow-hidden border border-neutral-200 bg-neutral-50">
          ...
          <div className="flex items-center justify-between border-b border-neutral-200 bg-neutral-100 px-4 py-2">
            <span className="text-xs font-mono font-semibold text-neutral-500">{block.language}</span>
            <div className="flex gap-1.5">
              <span className="h-2.5 w-2.5 bg-neutral-300" />
              <span className="h-2.5 w-2.5 bg-neutral-300" />
              <span className="h-2.5 w-2.5 bg-neutral-300" />
            </div>
          </div>
          <pre className="overflow-x-auto p-5 text-sm leading-relaxed text-neutral-700">
    ...
    case 'tip':
      return (
        <div className="border-l-4 border-black bg-neutral-50 border border-neutral-200 p-5">
          <div className="mb-2 flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-black">
...
function ArticleSkeleton() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 animate-pulse">
      <div className="mb-6 h-4 w-20 bg-neutral-100" />
      <div className="space-y-3">
        <div className="h-8 w-3/4 bg-neutral-100" />
        <div className="h-8 w-1/2 bg-neutral-100" />
      </div>
...
function PostNotFound({ slug }: { slug: string }) {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-6 px-4 text-center bg-white">
      ...
      <Link
        href="/"
        className="flex items-center gap-2 border border-neutral-200 bg-white px-5 py-2.5 text-sm font-semibold text-neutral-600 transition-all hover:border-black hover:text-black"
      >
  ...
  return (
    <div className="relative bg-white">
      ...
      <header className="relative mx-auto max-w-3xl px-4 pb-10 pt-14 sm:px-6 sm:pt-20">
        ...
        <Link
          href="/"
          className="mb-8 inline-flex items-center gap-1.5 text-sm font-medium text-neutral-400 transition-colors hover:text-black"
        >
          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
          </svg>
        ...
        <div className="mb-5 flex flex-wrap items-center gap-2">
          <span className="inline-flex items-center border border-neutral-200 bg-neutral-50 px-3 py-1 text-xs font-bold text-neutral-600">
            {post.category}
          </span>
          {post.featured && (
            <span className="inline-flex items-center gap-1.5 border border-neutral-200 px-3 py-1 text-xs font-semibold text-neutral-500">
      ...
      >
        ...
        <div className="mt-10 flex flex-col items-center gap-4 border border-neutral-200 bg-neutral-50 p-6 sm:flex-row sm:gap-6 sm:p-8">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="mt-0.5 text-base font-bold text-black">{post.author.name}</p>
          ...
          <Link
            href="/"
            className="shrink-0 border border-neutral-200 bg-white px-4 py-2 text-sm font-semibold text-neutral-600 transition-all hover:border-black hover:text-black"
          >
            More posts →
          </Link>
        </div>
